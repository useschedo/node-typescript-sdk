...
import {
  ...
  ExecutionListForJobParams,
  ExecutionListForJobResponse,
...
export class Jobs extends APIResource {
   ...
   */
  createDefinition(body: JobCreateDefinitionParams, options?: RequestOptions): APIPromise<Job> {
  ...
  pause(
    ...
    options?: RequestOptions,
  ): APIPromise<ExecutionsAPI.JobExecution> {
    const { 'X-API-ENVIRONMENT': xAPIEnvironment } = params;
...
export interface JobRetrieveResponse {
  ...
  last_run?: ExecutionsAPI.JobExecution;
}
...
export interface JobCreateDefinitionParams {
  name: string;
