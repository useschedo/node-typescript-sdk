...
[![NPM version](https://img.shields.io/npm/v/Schedo.svg)](https://npmjs.org/package/Schedo) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/Schedo)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/Schedo-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/Schedo-typescript/issues) with questions, bugs, or suggestions.
